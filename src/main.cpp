...
uint256 hashGenesisBlock("0x1c83c7efbb4c52ab2c8d6cba836aba7ccddd90f8d6992f8ca732579024613003");
...
const string strMessageMagic = "Crazycoin Signed Message:\n";
...
static const int64 nTargetTimespan = 2 * 60; 
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal crazycoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Crazycoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8f2338383e8850f206c737ff82095e22347c68597f7e767bc939860a5550d19b");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Live fast but die old.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1380974929; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2363058;

        if (fTestNet)
        {
            block.nTime    = 1380972643;
            block.nNonce   = 261743;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x66cbd596b32cc64e31951e3076673eb89eceeb1b01467a44ed7b0ef9dcc42699"));
