...
**
** Created: Mon 31. Mar 08:34:35 2014
...
static const char qt_meta_stringdata_BitcoinAddressValidator[] = {
    "BitcoinAddressValidator\0"
};
...
const QMetaObject BitcoinAddressValidator::staticMetaObject = {
    { &QValidator::staticMetaObject, qt_meta_stringdata_BitcoinAddressValidator,
      qt_meta_data_BitcoinAddressValidator, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &BitcoinAddressValidator::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BitcoinAddressValidator))
