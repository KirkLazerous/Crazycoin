...
**
** Created: Mon 31. Mar 08:34:37 2014
...
static const char qt_meta_stringdata_TransactionDescDialog[] = {
...
const QMetaObjectExtraData TransactionDescDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TransactionDescDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_TransactionDescDialog,
      qt_meta_data_TransactionDescDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &TransactionDescDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TransactionDescDialog))
